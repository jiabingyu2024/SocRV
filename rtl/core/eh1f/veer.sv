...
(
   ...
   // Single-outstanding local MMIO master used by the TCM-only SoC.
...
`ifdef RV_ICCM_ENABLE
   ...
   output logic [63:0]           iccm_wr_data,
...
`endif
   ...
   assign pic_pl      = 4'b0;
   assign picm_rd_data = 32'b0;

   assign dma_dccm_req       = 1'b0;
   assign dma_iccm_req       = 1'b0;
   assign dma_mem_addr       = 32'b0;
   assign dma_mem_sz         = 3'b0;
   assign dma_mem_write      = 1'b0;
   assign dma_mem_wdata      = 64'b0;
   assign dma_dccm_stall_any = 1'b0;
   assign dma_iccm_stall_any = 1'b0;
   assign dma_mem_dccm_req   = 1'b0;
   assign dma_dbg_ready      = 1'b0;
   assign dma_dbg_cmd_done   = 1'b0;
   assign dma_dbg_cmd_fail   = 1'b1;
   assign dma_dbg_rddata     = 32'b0;
   assign dma_slv_algn_err   = 1'b0;
