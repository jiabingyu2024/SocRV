...
`include "core_params.svh"
   ...
   assign lsu_offset_d[11:0] = dec_lsu_offset_d[11:0];
   ...
   assign addr_offset_dc1[2:0]      = ({3{lsu_pkt_dc1.half}} & 3'b01) | ({3{lsu_pkt_dc1.word}} & 3'b11);
   ...
   assign lsu_single_ecc_error_incr = lsu_single_ecc_error_dc5 & lsu_commit_dc5;


   assign lsu_error_pkt_dc3.exc_valid = (access_fault_dc3 | misaligned_fault_dc3 | ld_bus_error_dc3 | lsu_double_ecc_error_dc3) & lsu_pkt_dc3.valid & ~flush_dc3;
   ...
   always_comb begin
      ...
      lsu_pkt_dc1_in.valid = lsu_p.valid & ~flush_dc2_up;
      lsu_pkt_dc2_in.valid = lsu_pkt_dc1.valid & ~flush_dc2_up;
      lsu_pkt_dc3_in.valid = lsu_pkt_dc2.valid & ~flush_dc2_up;
      lsu_pkt_dc4_in.valid = lsu_pkt_dc3.valid & ~flush_dc3 & ~lsu_freeze_dc3;
      lsu_pkt_dc5_in.valid = lsu_pkt_dc4.valid & ~flush_dc4;
   end
   ...
   assign lsu_commit_dc5 = lsu_pkt_dc5.valid & (lsu_pkt_dc5.store | lsu_pkt_dc5.load) & ~flush_dc5;

   assign store_data_d[63:0] = {32'b0,exu_lsu_rs2_d[31:0]};
   ...
   assign store_data_dc3[31:0] = lsu_pkt_dc3.store_data_bypass_e4_c3[1] ? i1_result_e4_eff[31:0] :
                                  lsu_pkt_dc3.store_data_bypass_e4_c3[0] ? i0_result_e4_eff[31:0] :
                                                                         store_data_pre_dc3[31:0];
