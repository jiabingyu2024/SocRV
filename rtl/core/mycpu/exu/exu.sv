...
(
   ...
   output logic exu_i0_inst_misaligned_e4,
   output logic exu_i1_inst_misaligned_e4,
   output logic [31:1] exu_i0_inst_misaligned_addr_e4,
   output logic [31:1] exu_i1_inst_misaligned_addr_e4,

   output predict_pkt_t exu_mp_pkt,

   output logic [`RV_BHT_GHR_RANGE]  exu_mp_eghr,
   ...
   always_comb begin
      ...
      i0_predict_newp_d.index[`RV_BTB_ADDR_HI:`RV_BTB_ADDR_LO] = i0_predict_p_d.index[`RV_BTB_ADDR_HI:`RV_BTB_ADDR_LO];
   ...
   exu_alu_ctl i0_alu_e1 (.*,
                          ...
                          .out           ( exu_i0_result_e1[31:0]      ),
                           ...
                           .target_misaligned ( i0_target_misaligned_e1 ),
   ...
   exu_alu_ctl i1_alu_e1 (.*,
                          ...
                          .out           ( exu_i1_result_e1[31:0]      ),
                           ...
                           .target_misaligned ( i1_target_misaligned_e1 ),
   ...
   exu_alu_ctl i0_alu_e4 (.*,
                          ...
                          .out           ( exu_i0_result_e4[31:0]      ),
                           ...
                           .target_misaligned ( i0_target_misaligned_lower_e4 ),
   ...
   exu_alu_ctl i1_alu_e4 (.*,
                          ...
                          .out           ( exu_i1_result_e4[31:0]      ),
                           ...
                           .target_misaligned ( i1_target_misaligned_lower_e4 ),
   ...
   assign exu_mp_pkt.fghr[`RV_BHT_GHR_RANGE]                = after_flush_eghr[`RV_BHT_GHR_RANGE];

   assign exu_mp_eghr[`RV_BHT_GHR_RANGE] = final_predict_mp_ff.fghr[`RV_BHT_GHR_RANGE];
