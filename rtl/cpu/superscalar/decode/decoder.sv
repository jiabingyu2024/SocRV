...
module decoder (
    ...
    always_comb begin
            ...
            7'b1110011: begin
                ...
                if (funct3 == 3'b000) begin
                    unique case (fetch_i.instr[31:20])
                        ...
                        12'h001: begin uop_o.sys_op = SYS_EBREAK; uop_o.exception_valid = 1'b1; uop_o.exception_cause = 5'd3;  uop_o.exception_tval = fetch_i.pc; end
        ...
        if (fetch_i.access_fault) begin
            ...
            uop_o.exception_valid = 1'b1;
            uop_o.exception_cause = 5'd1;
            uop_o.exception_tval  = fetch_i.pc;
        end
