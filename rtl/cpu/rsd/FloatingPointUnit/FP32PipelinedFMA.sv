...
module FMAStage0(
    ...
    wire mullhs_is_snan = mullhs_is_nan & !mullhs_mant[22];
    wire mulrhs_is_snan = mulrhs_is_nan & !mulrhs_mant[22];
    wire addend_is_snan = addend_is_nan & !addend_mant[22];
    wire invalid_op = mullhs_is_snan | mulrhs_is_snan | addend_is_snan |
                      (mullhs_is_zero & mulrhs_is_inf) |
                      (mullhs_is_inf & mulrhs_is_zero) |
                      (is_subtract & (mullhs_is_inf | mulrhs_is_inf) & addend_is_inf);
    ...
    assign stg0Out = {mulres_expo, result_is_inf, result_is_nan, invalid_op,
...
module FMAStage2(
    ...
    assign stg2Out = {abs_fma_result, pipeReg.mulres_expo, res_is_negative, pipeReg.result_is_inf,
                      pipeReg.result_is_nan, pipeReg.invalid_op, res_is_zero, pipeReg.res_is_addend, result_sign,
...
module FMAStage3(
    ...
    assign stg3Out = {abs_fma_result, fmares_shift, virtual_expo, subnormal, pipeReg.res_is_negative, pipeReg.result_is_inf,
                      pipeReg.result_is_nan, pipeReg.invalid_op, pipeReg.res_is_zero, pipeReg.res_is_addend, pipeReg.result_sign,
                      pipeReg.prop_inf_sign, pipeReg.addend_sign, pipeReg.is_subtract, pipeReg.nan, pipeReg.addend};
endmodule
...
module FMAStage4(
    ...
    wire invalid_op            = pipeReg.invalid_op;
    ...
    wire       finite_overflow = !result_is_inf && !result_is_nan &&
                                 ($signed(virtual_expo) >= 255);
    wire       inexact = shifter_result[0] | sticky | finite_overflow;
    ...
    always_comb begin
        fflags = '0;
        fflags.NV = invalid_op;
        fflags.OF = finite_overflow;
        fflags.UF = subnormal && inexact && !result_is_nan;
        fflags.NX = inexact && !result_is_nan;
    end
endmodule
