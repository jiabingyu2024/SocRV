package soc_config_pkg;
  ...
  parameter int unsigned CORE_CLOCK_HZ  = 120_000_000;
  parameter int unsigned PERIPH_CLOCK_HZ = 50_000_000;
  // Compatibility alias for CPU-side performance counters and software.
  parameter int unsigned SOC_CLOCK_HZ   = CORE_CLOCK_HZ;
