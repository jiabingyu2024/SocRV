...
Current stage: C - fixed-width RV32IM with cacheless, no-ECC TCM datapaths.
...
backup/20260809_162200_eh1_stage_b. The active Stage-C core advertises the
...
logic are absent. PIC, DMA, bus compatibility ports and the upstream wrapper
remain for the next staged edit.

rtl/filelist.f selects rtl/filelist_stage_c.f. Historical stage filelists are
