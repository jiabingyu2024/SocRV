...
`endif // !`ifdef RV_BTB_48
   ...
   // IALIGN=32: every valid BTB entry describes a four-byte instruction.
   // The physical PC4 bit is retained temporarily to avoid changing the BTB
   // RAM width in the same stage, but it no longer controls prediction.
