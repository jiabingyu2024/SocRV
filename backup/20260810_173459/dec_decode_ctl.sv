...
// end debug
   ...
   assign i1_block_d = leak1_i1_stall |
              ...
              (((|dec_i0_trigger_match_d[3:0]) | ((i0_dp.condbr | i0_dp.jal) & i0_secondary_d)) & i1_dp.load ) | // if branch or branch error then don't allow i1 load
                       ...
                       i1_fp_any; // FP instructions are always re-presented in slot 0
...
// divide stuff
   ...
   // ------------------------------------------------------------------
   // RV32F long-operation path.  FP arithmetic is serialized like divide:
   // prior instructions drain, FPnew runs off the integer critical path, and
   // one completion is injected into the normal precise-retirement stream.
