...
(
   ...
   input logic exu_i0_inst_misaligned_e4,   // slot 0 taken target violates IALIGN=32
   input logic exu_i1_inst_misaligned_e4,   // slot 1 taken target violates IALIGN=32
   input logic [31:1] exu_i0_inst_misaligned_addr_e4, // slot 0 faulting target
   input logic [31:1] exu_i1_inst_misaligned_addr_e4, // slot 1 faulting target
