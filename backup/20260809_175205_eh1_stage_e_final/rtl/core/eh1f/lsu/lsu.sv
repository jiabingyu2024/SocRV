...
(
   ...
   // TCM-only local peripheral interface
...
`include "global.h"
   ...
   // Kept only as a temporary compatibility net for the Stage-C controller
   // boundary.  No ECC is generated or stored in the active TCM-only path.
