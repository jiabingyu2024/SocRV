...
module core_top (
    ...
    csr_file u_csr (
        ...
        .cycle_i(cycle_q), .instret_i(commit_count_q), .mtvec_o(csr_mtvec),
    ...
    commit_trace_probe u_commit_trace_probe (
        ...
        .issue_uop_i(id_uop_q),
        .issue_src1_i(((id_uop_q.fu == FU_LOAD) ||
                       (id_uop_q.fu == FU_STORE)) ? src1_mem_value : src1_value),
