...
`ifndef SYNTHESIS
                if (hxi.rsp_err)
                    $display("RSD_ICACHE_HXI_ERROR addr=%08x beat=%0d serial=%0d",
                             addr_q[rsp_ptr_q], rsp_count_q[rsp_ptr_q],
                             serial_q[rsp_ptr_q]);
`endif
...
`ifndef SYNTHESIS
                if (hxi.rsp_err)
                    $display("RSD_DCACHE_HXI_ERROR addr=%08x beat=%0d write=%0d uncached=%0d rserial=%0d wserial=%0d",
                             addr_q[rsp_ptr_q], rsp_count_q[rsp_ptr_q],
                             write_q[rsp_ptr_q], uncached_q[rsp_ptr_q],
                             read_serial_q[rsp_ptr_q], write_serial_q[rsp_ptr_q]);
`endif
