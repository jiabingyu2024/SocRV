...
`ifndef SYNTHESIS
   always_ff @(posedge active_clk) begin
      if (rst_l && wen0) $display("EH1F_GPR_WRITE p0 x%0d=%08x", waddr0, wd0);
      if (rst_l && wen1) $display("EH1F_GPR_WRITE p1 x%0d=%08x", waddr1, wd1);
      if (rst_l && wen2) $display("EH1F_GPR_WRITE p2 x%0d=%08x", waddr2, wd2);
   end
`endif
