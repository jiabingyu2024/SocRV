...
// Architectural completion export used by the SocRV wrapper.  The initial
// integration disables dual issue, so slot 1 is exposed only as an assertion
// guard and must remain low.
