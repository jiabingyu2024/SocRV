module local_peripheral_subsystem #(
   ...
   assign timer_sel   = req_valid && (req_addr[31:12] == 20'h10000);
   assign uart_sel    = req_valid && (req_addr[31:12] == 20'h10001);
   assign gpio_sel    = req_valid && (req_addr[31:12] == 20'h10002);
   assign sysctrl_sel = req_valid && (req_addr[31:12] == 20'h10003);
   ...
   sysctrl #(.CLOCK_HZ(CLOCK_HZ)) sysctrl0 (
      ...
      .req_rdata(sysctrl_rdata), .test_status
   );
endmodule
