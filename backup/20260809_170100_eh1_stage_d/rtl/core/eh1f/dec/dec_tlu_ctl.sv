...
assign dec_csr_legal_d = ( dec_csr_any_unq_d &
   ...
   // CSR read mux
 // Stage-B advertises RV32IM only. The F bit is added atomically with the
 // FPR/FPU/FCSR implementation; C remains permanently clear.
 assign dec_csr_rddata_d[31:0] = ( ({32{csr_misa}}      & 32'h40001100) |
