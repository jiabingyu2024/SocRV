...
def main() -> int:
    ...
    parser.add_argument(
        "--core-mhz", type=int, choices=(100, 125, 150, 175, 200, 250), default=100,
    ...
    parser.add_argument(
        "--synth-only",
        action="store_true",
        help="stop after synthesis and generate the early-iteration timing reports",
    )
    ...
    command = [
        ...
        str(image_dir),
        str(args.jobs),
        "synth" if args.synth_only else "bitstream",
    ]
    # The board MMCM uses a 1 GHz VCO (200 MHz input, CLKFBOUT_MULT_F=5).
    # Keep the frequency sweep explicit and reproducible.  The 150/175 MHz
    # points use the nearest legal 1/8-step MMCM divider and are reported by
    # Vivado as the actual clock frequency; 100/125/200/250 MHz are exact.
    divide = {
        100: "10.0",
        125: "8.0",
        150: "6.625",
