...
#define SOCRV_SOC_CLOCK_HZ 120000000u
#define SOCRV_PERIPH_CLOCK_HZ 50000000u
#define SOCRV_TIMER_CLOCK_HZ 120000000u
#define SOCRV_UART_BAUD 115200u
#define SOCRV_UART_DIVISOR (SOCRV_PERIPH_CLOCK_HZ / SOCRV_UART_BAUD)
