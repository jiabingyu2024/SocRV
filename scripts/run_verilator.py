...
def run_image(
    ...
    *,
    ...
    # the C++ harness's historical 50 MHz default makes a valid image built for
    # the generated frequency look like framing-error garbage and hides real
    # board-safety regressions.
    contract = read_json(
